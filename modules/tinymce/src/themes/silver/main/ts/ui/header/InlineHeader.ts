import { AlloyComponent, Boxes, Channels, Docking, Gui, VerticalDir } from '@ephox/alloy';
...
export interface InlineHeaderUiReferences {
...
export const InlineHeader = (
  ...
  uiRefs: InlineHeaderUiReferences,
